...
<form>
    ...
    <div style="margin-left: 344px; margin-top: 50px; height: 35px; padding-top: 12px; padding-left: 12px; background-color: #EDEDED; color: #000000; font-size: 17px; font-weight: bold; width: 293px;">
