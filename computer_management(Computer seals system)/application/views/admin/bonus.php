...
<div class="sallery">
    ...
    <span style="float: left; height: 32px; width: 91.6%; background-color: #003366; color: white; font-weight: bold; font-size: 18px; text-align: center; margin-top: 10px; margin-bottom: 10px;">Bonus History</span>
        ...
        <table bgcolor="#d3d3d3" width="100%;">
            ...
            <form action = "<?php echo base_url(); ?>admin/BonusPaid" method = "post">
                ...
                <td colspan="2">
                    ...
                    <input type="text" name="paid_bonus" style="color:blue;"/>
