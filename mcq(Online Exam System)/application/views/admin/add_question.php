<form action="<?php echo base_url();?>admin/QuestionForm" method="post">

    <table align="center" cellspacing="1" width="59%" style="float: left; line-height: 20px; margin-left:123px;">
        <tr  bgcolor="#73C69D">
            <td colspan="2" align="center"><h3>Add question!</h3></td>
        </tr>
        <tr bgcolor="#FFFFFF">
