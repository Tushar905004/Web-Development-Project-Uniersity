 ...
 */
(function($,window,top){var instance;$.history=function(method,param){if(typeof method=="function"){param=method;method="bind"}else{if(/bind|unbind/.test(method)&&!$.isFunction(param)){return}}if(!instance){instance=new hist();instance.init()}if(method!="init"){instance[method](param)}};function hist(){var self=this,IE67=($.browser.msie&&parseInt($.browser.version,10)<8),IE8=($.browser.msie&&parseInt($.browser.version,10)>=8),$iframe,$wnd=$(window),stop=false;self.value=top.location.hash.substr(1);this.init=function(){if(IE8){$wnd.bind("hashchange",IE8Handler)}else{if(IE67){initIframe()}else{(function(){if(stop){return}if(top.location.hash.substr(1)!==self.value){changed(top.location.hash)}setTimeout(arguments.callee,50)})()}}};this.destroy=function(){stop=true;if($iframe){$iframe.remove()}$wnd.unbind("hashchanged");instance=null;if(IE8){$wnd.unbind("hashchange",IE8Handler)}};this.bind=function(callback){$wnd.bind("hashchanged",callback)};this.unbind=function(callback){$wnd.unbind("hashchanged",callback)};this.add=function(value){top.location.hash=value};this.forward=function(){history.go(1)};this.back=function(){history.go(-1)};function initIframe(){$iframe=$iframe||$('<iframe style="display: none;" class="x-history-iframe"/>').appendTo(document.body);try{$iframe[0].contentWindow}catch(e){setTimeout(arguments.callee,50);return}var iHash=iDoc().location.hash,hash=top.location.hash,iHashNew,hashNew;(function(){if(stop){return}iHashNew=iDoc().location.hash;hashNew=top.location.hash;if(iHashNew!==iHash){iHash=iHashNew;hash=iHash;top.location.hash=changed(iHash)}else{if(hashNew!==hash){hash=hashNew;updateIFrame(hash)}}setTimeout(arguments.callee,50)})();function iDoc(){return $iframe[0].contentWindow.document}function updateIFrame(value){iDoc().open();iDoc().close();iDoc().location.hash=value}}function changed(value){self.value=value.substr(1);$.event.trigger("hashchanged",[self]);return self.value}function IE8Handler(e){changed(top.location.hash)}}})(jQuery,window,top);
...
function shuffle(a){var b=a.length;if(b<2){return}do{var c=Math.floor(Math.random()*b);var d=a[c];a[c]=a[--b];a[b]=d}while(b)}function shuffle_array(a){var b=a.length;if(b==0){return false}while(--b){var c=Math.floor(Math.random()*(b+1));var d=a[b];var e=a[c];a[b]=e;a[c]=d}}function shuffle_ads(a,b){var c=[];var d=[];if(typeof OA_output==="undefined"){return}for(var e=1;e<=b;e++){if(OA_output[a+" "+e]!==undefined&&OA_output[a+" "+e]!=""){c.push(OA_output[a+" "+e]);d.push(e)}}shuffle_array(c);var f=0;for(var e=1;e<=b;e++){if(d.indexOf(e)!=-1&&c[f]!==undefined){OA_output[a+" "+e]=c[f];f++}else{OA_output[a+" "+e]=""}}}function adMover(a,b){var c=document.getElementById(b),d=document.getElementById(a);if(c&&d){c.appendChild(d)}}function my_OA_show(a,b){if(typeof OA_output[a]=="undefined"){return}if(b!==""){document.write("<d"+'iv id="'+b+'">'+OA_output[a]+"</d"+"iv>")}}function OA_show_inject(a,b){if(typeof OA_output[a]=="undefined"){return}var c=document.getElementById(b);if(c){c.innerHTML=OA_output[a]}}function isthere(a){return document.getElementById(a)}function hidetrackinglinks(){var a=document.getElementsByTagName("a");var b=a.length;for(var c=0;c<b;c++){var d=document.getElementsByTagName("a")[c].href;if(d.substring(0,68)=="http://auslieferung.commindo-media-ressourcen.de/www/delivery/ck.php"){var e=d.split("oadest=");var f=unescape(e[1]);a[c].href=f;a[c].setAttribute("onmousedown","this.href='"+d+"'")}}}function ads_init(){for(var a=0;a<zones_available.length;a++){var b=zones_available[a];if(isthere(b.domid)){OA_zones[b.name]=b.val}}for(var a=1;a<=numvis;a++){OA_zones["VIS "+a]=70}for(var a=1;a<=numspnsrs;a++){OA_zones["spnsr ROS "+a]=24}OA_zones["Specials"]=67}function ads_display(){if(!$("#wpsidebar").is(":visible")){for(var a=1;a<=numvis;a++)extract_beacon("VIS "+a);for(var a=1;a<=numspnsrs;a++)extract_beacon("spnsr ROS "+a);extract_beacon("Sidebar 1");extract_beacon("Sidebar 2");extract_beacon("Sidebar 3");extract_beacon("Sidebar Special");extract_beacon("Sponsor XXL")}document.write("<d"+'iv id="edpool">');edsok=typeof OA_source=="string"&&OA_source=="";var b=[],c=0,d=[];if(OA_output["Sponsor XXL"]!==undefined&&OA_output["Sponsor XXL"]!="")numspnsrs-=2;for(var a=1;a<=numvis;a++){if(edsok&&OA_output["VIS "+a]!==undefined&&OA_output["VIS "+a]!=""){d.push(OA_output["VIS "+a])}}for(var a=1;a<=numspnsrs-d.length;a++){if(edsok&&OA_output["spnsr ROS "+a]!==undefined&&OA_output["spnsr ROS "+a]!=""){b.push(OA_output["spnsr ROS "+a])}}var e=Math.floor(Math.random()*((d.length+b.length)/2+1));shuffle(b);while(d.length<numvis&&b.length>0)d.push(b.shift());shuffle(d);document.write("<"+"u"+'l id="spnsrlist" class="bnnr-list">');for(var a=0;d[a]!==undefined;a++){if(a/2==e&&OA_output["Sponsor XXL"]!==undefined&&OA_output["Sponsor XXL"]!=""){document.write("<"+"l"+'i class="double">'+OA_output["Sponsor XXL"]+"</"+"l"+"i>")}document.write("<"+"l"+"i>"+d[a]+"</"+"l"+"i>")}for(var a=0;b[a]!==undefined;a++){if((a+d.length)/2==e&&OA_output["Sponsor XXL"]!==undefined&&OA_output["Sponsor XXL"]!=""){document.write("<"+"l"+'i class="double">'+OA_output["Sponsor XXL"]+"</"+"l"+"i>")}document.write("<"+"l"+"i>"+b[a]+"</"+"l"+"i>")}if(e==Math.floor((d.length+b.length)/2)&&OA_output["Sponsor XXL"]!==undefined&&OA_output["Sponsor XXL"]!=""){document.write("<"+"l"+'i class="double">'+OA_output["Sponsor XXL"]+"</"+"l"+"i>")}document.write("</"+"u"+"l>");my_OA_show("Comment spnsr","commentspnsr");shuffle_ads("Sidebar",3);my_OA_show("Sidebar 1","sidebared");my_OA_show("Sidebar 2","sidebaredtwo");my_OA_show("Sidebar 3","sidebaredthree");my_OA_show("Sidebar Special","sidebarspecial");if(OA_output["Special Ad"]===undefined||OA_output["Special Ad"]==""){my_OA_show("Logo","logoed")}my_OA_show("Medium Rectangle","mediumrectangle");my_OA_show("Homepage prem Ad","homepagepremed");OA_show("Textad");document.write("</d"+"iv><!-- /#edpool -->");hidetrackinglinks()}function extract_beacon(a){if(OA_output[a]==undefined)return;var b=OA_output[a].search(/\<div id\=\'beacon_[a-z0-9]+\'.*\<\/div\>\s*/);if(b!=-1){OA_beacons[a]=OA_output[a].substr(b);OA_output[a]=OA_output[a].substring(0,b)}}if(!Array.prototype.indexOf){Array.prototype.indexOf=function(a){var b=this.length>>>0;var c=Number(arguments[1])||0;c=c<0?Math.ceil(c):Math.floor(c);if(c<0)c+=b;for(;c<b;c++){if(c in this&&this[c]===a)return c}return-1}}var numspnsrs=16,numvis=10,OA_zones={};var OA_beacons={};var zones_available=[{name:"Sidebar 1",val:40,domid:"sidebaredtarget"},{name:"Sidebar 2",val:40,domid:"sidebaredtwotarget"},{name:"Sidebar 3",val:40,domid:"sidebaredthreetarget"},{name:"Medium Rectangle",val:22,domid:"mediumrectangletarget"},{name:"Comment spnsr",val:26,domid:"commentspnsrtarget"},{name:"Logo",val:39,domid:"logoedtarget"},{name:"Homepage prem Ad",val:25,domid:"homepagepremedtarget"},{name:"Textad",val:68,domid:"textadtarget"},{name:"Sidebar Special",val:72,domid:"sidebarspecialtarget"},{name:"Sponsor XXL",val:77,domid:"spnsrlisttarget"}];var edsok=false;$(document).ready(function(){adMover("sidebared","sidebaredtarget");adMover("sidebaredtwo","sidebaredtwotarget");adMover("sidebaredthree","sidebaredthreetarget");adMover("mediumrectangle","mediumrectangletarget");adMover("spnsrlist","spnsrlisttarget");adMover("commentspnsr","commentspnsrtarget");adMover("premspnsr","premspnsrtarget");adMover("logoed","logoedtarget");adMover("homepagepremed","homepagepremedtarget");adMover("textad","textadtarget");adMover("sidebarspecial","sidebarspecialtarget")})