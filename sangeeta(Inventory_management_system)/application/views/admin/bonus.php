<div style="margin-left: 212px; padding-left: 3px;">
    <form action="<?php echo base_url(); ?>admin/selectUserForBonus" method="post">
        <table>
            ...
            <tr bgcolor="#99CCCC"><td><strong>&nbsp;&nbsp;User Id:</strong>
                    <select name="user_id" required="1">
                        ...
                        while($fetch_x=mysql_fetch_array($query)) {
                            ?>
                        <option value="<?php echo $fetch_x['user_id']; ?>"><?php echo $fetch_x['user_id']; echo " ( ".$fetch_x['user_name']." )"; ?></option>
                            <?php } ?>
                    </select>
                    ...
                    <input type="submit" value="Pay Bonus" name="src">
                    <a href="<?php echo base_url(); ?>admin/viewAllBonus"><input type="button" value="View All Bonus"></a>
                </td>
            </tr>
...
<div class="sallery">
    ...
    <span style="float: left; height: 32px; width: 100%; background-color: #003366; color: white; font-weight: bold; font-size: 18px; text-align: center; margin-top: 10px; margin-bottom: 10px;">Bonus History</span>
    <div class="sallery_bottom">
        <table bgcolor="gray" width="100%" cellspacing="1">
                    ...
                    if (isset($result1)) {
                        if (!$result1) {
                            echo"<tr bgcolor='#f8f8f8' style='color:red'><td colspan='3' align='center'>You have not yet give bous.</td></tr>";
                        } else {
                            ?>
            <tr bgcolor="#99CCCC" style="color: #003366;">
                ...
                <th>Paid Date</th>
                            ...
                            foreach ($result1 as $row) {
                                $total_paid+=$row->paid_bonus;
                                ?>
            <tr bgcolor="#f8f8f8">
                <td><?php echo $row->paid_bonus; ?></td>
                <td><?php echo $row->pay_month."/".$row->pay_year; ?></td>
                <td><?php echo $row->paid_date; ?></td>
                        ...
                        <?php if ($total_paid == $result->sallery) {
                            ...
                            ?>
            <tr style=" background-color: #C6D988; border:0;">
                <td colspan="3" align="center"><b style="color:green;">Total Paid: <?php echo $total_paid; ?> Tk</b></td>
            </tr>
            <tr bgcolor = "#C6D988">
            <form action = "<?php echo base_url(); ?>admin/BonusPaid" method = "post">
                <td>Now Pay:(<?php echo $pay_month." / ".$pay_year;
                                    ?>)</td>

                <td colspan="2">

                    <input type="text" name="paid_bonus" style="color:blue;" onkeydown="return ( event.ctrlKey || event.altKey
