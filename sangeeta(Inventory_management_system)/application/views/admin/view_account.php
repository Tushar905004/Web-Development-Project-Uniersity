<div style="float: left; margin-left: 20px;">
    <fieldset style="width: 870px; padding-left: 15px; padding-top:30px; padding-right: 12px; padding-bottom: 12px; font-weight: normal; line-height: 23px; font-family: arial; font-size: 13px;">
        ...
        <?php
        $q=mysql_query("select * from tbl_personal_account order by account_id DESC LIMIT 20");
        $i=0;
        $total=0;
...
<?php
        if($i%2==0){ ?>
        <tr bgcolor="#E8ECBA" align="center">
            <?php } else{ ?>
            ...
            ?>
            <tr>
                <td colspan="5" align="center" style="font-weight: bold; background-color: #E9BDB8; color: blue;">Total Amount: <?php echo $total; ?> Tk</td>
            </tr>
            </table>
