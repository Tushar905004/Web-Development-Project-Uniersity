...
<script type="text/javascript">
    function showUser(str)
    {
        ...
        xmlhttp.open("POST","<?php echo base_url(); ?>user/retriveSubCategory_stock/"+str,true);
        xmlhttp.send();
    }
</script>
...
//$category_id=$fetch['category_id'];
    ...
    if(isset($_SESSION['errMessage'])) {
        echo "<div style=' margin-top:12px; margin-left:310px; margin-bottom:-10px;'".$_SESSION['errMessage']."<input class='back_btn' type='button' value='back' onclick='javascript:history.go(-1);'></div>";
        echo "";
        unset($_SESSION['errMessage']);
    }
    ?><br><br>
    <font color="#003366" face="SolaimanLipi"><u style="font-size: 25px;">নির্দেশাবলী:-</u><br>* গোডাউনে থাকা পণ্যসমুহ স্টকে নিতে পারবেন।
    <br>* প্রথমে ক্যাটাগরি তারপর সাব ক্যাটাগরি সিলেক্ট করুন।</font>