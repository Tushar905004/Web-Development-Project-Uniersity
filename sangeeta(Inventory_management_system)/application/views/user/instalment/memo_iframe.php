...
<span style="float:left; margin-left:35%; font-family:'Courier New', Courier, monospace"> Date: <?php echo $row['date']; ?></span><br>
<?php
...
<div class="right_footer">
    ...
    <div class="left_sign">
        <u>Seller Signature:</u> <br>
<font style="font-size: 13px; font-family:Times; font-style: italic;"><?php echo $row['sell_by']; ?></font>
    </div>
	</div>
