...
<script type="text/javascript">
    function showUser(str)
    {
        ...
        xmlhttp.open("POST","<?php echo base_url(); ?>user/retriveSubCategoryForView_stock/"+str,true);
        xmlhttp.send();
    }
</script>
...
<br><br>
<font color="#003366" face="SolaimanLipi"><u style="font-size: 25px;">&nbsp;নির্দেশাবলী:-</u><br>* স্টকে  থাকা সকল পণ্য দেখতে পারবেন।<br>* পন্যসমুহ ইডিট অথবা ডিলেট কতে পারবেন।<br>
