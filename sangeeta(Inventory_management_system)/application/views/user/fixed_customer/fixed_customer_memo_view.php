...
<hr/><hr/>
	...
	<hr/>
<?php
$qx=mysql_query("select * from tbl_sell_history where memo_id='$memo_id'");
...
?>
	...
	<tr>
		<td>Customer Name:</td>
                <td><input type="text" name="cus_name" class="input_de" value="<?php echo $fetch1['cus_name']; ?>" readonly size="55">
                </td>
	</tr>
	<tr>
		<td>Address:</td>
                <td><input type="text" name="cus_name" class="input_de" value="<?php echo $fetch1['address']; ?>" readonly size="55">
                </td>
	</tr>
	<tr>
		<td>Mobile No:</td>
                <td><input type="text" name="cus_name" class="input_de" value="<?php echo $fetch1['mob_no']; ?>" readonly size="55">
                </td>
	</tr>
	</table>
...
<div class="right_footer">
    <table  width="" cellspacing="1" bgcolor="gray" height="75">
        <tr bgcolor="white">
            ...
            <td width="93">&nbsp;<?php echo $row['total_price']; ?> Tk</td>
	</tr>
	<tr bgcolor="white">
            <td bgcolor="#f8f8f8">Paid:</td>
            <td>&nbsp;<?php echo $row['paid']; ?> Tk</td>
	</tr>
	<tr bgcolor="white">
		<td bgcolor="#f8f8f8">Due:</td>
                <td>&nbsp;<?php echo $row['total_price']-$row['paid'] ?> Tk</td>
	</tr>
</table>
</div>
	</div>
