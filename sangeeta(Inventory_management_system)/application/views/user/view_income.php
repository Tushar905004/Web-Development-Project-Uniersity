...
<div style="float: left; margin-left: 20px;">
    <fieldset style="width: 870px; padding-left: 15px; padding-top:30px; padding-right: 12px; padding-bottom: 12px; font-weight: normal; line-height: 23px; font-family: arial; font-size: 13px;">
        <legend style="font-size:18px; color: #00CCFF;" align="center"> View Other Income History</legend>
        ...
        <?php
        $total=0;
        $q=mysql_query("select * from tbl_income");
         $i=0;
     ...
     <?php
        ...
        <tr bgcolor="#FEFEFE" align="center">
            ...
            <td>
                ...
                <a href="<?php echo base_url(); ?>user/edit_income/<?php echo $row['income_id']; ?>" style="text-decoration: none;">
                    <img src="<?php echo base_url(); ?>images/b_edit.png" title="EDIT" />
                </a>&nbsp;&nbsp;&nbsp;
                <a href="<?php echo base_url(); ?>user/delete_income/<?php echo $row['income_id']; ?>">
