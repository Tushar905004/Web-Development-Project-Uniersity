...
<script type="text/javascript">
    function showUser(str)
    {
        ...
        xmlhttp.open("POST","<?php echo base_url(); ?>user/retriveSubCategoryForView/"+str,true);
        xmlhttp.send();
    }
</script>
...
<br>
<br>
<font color="#003366" face="SolaimanLipi"><u style="font-size: 25px;">নির্দেশাবলী:-</u><br>* গোডাউনে থাকা সকল পণ্য দেখতে পারবেন।<br>* পন্যসমুহ ইডিট অথবা ডিলেট করতে পারবেন।<br>
* প্রথমে ক্যাটাগরি তারপর সাব ক্যাটাগরি সিলেক্ট করুন।
</font>