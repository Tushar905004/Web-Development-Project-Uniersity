...
<fieldset style="width: 466px; height: auto; padding-left: 15px; padding-top:30px; font-weight: bold; font-family: arial; font-size: 13px;">
 <legend style="font-size:18px; color: #00B5FF;" align="center">Edit Income </legend>
<form action="<?php echo base_url(); ?>user/UpdateIncomeSave" method="post">
<table class="add_vendor_tbl">
    ...
    <tr>
    <input type="hidden" name="income_id" value="<?php echo $result->income_id; ?>"/>
